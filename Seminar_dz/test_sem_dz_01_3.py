...
# Задача с факториалом (тест pytest)
...
class TestFactorialGenerator:
    def test_generate_factorials_01(self):
        ...
        assert list(generator.generate_factorials()) == [1, 2, 6, 24, 120]

    def test_generate_factorials_02(self):
        generator = FactorialGenerator(2, 10, 2)
        assert list(generator.generate_factorials()) == [2, 24, 720, 40320, 3628800]

    def test_generate_factorials_03(self):
        generator = FactorialGenerator(5)
        assert list(generator.generate_factorials()) == [120]
